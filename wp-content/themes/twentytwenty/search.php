    ...
    <main id="main" class="site-main mt-5" role="main">
        <div class="container">
                    ...
                    <div class="col-md-10 col-lg-12">
                        <form class="card card-sm" role="search" method="get" class="search-form" action="<?php echo esc_url(home_url('/')); ?>">
                            <div class="card-body row no-gutters align-items-center p-4">
                                ...
                                <!--end of col-->
                                <div class="col">
                                    <input class="form-control form-control-lg form-control-borderless search-field" id="<?php echo esc_attr($twentytwenty_unique_id); ?>" placeholder="<?php echo esc_attr_x('Search &hellip;', 'placeholder', 'twentytwenty'); ?>" value="<?php echo get_search_query(); ?>" name="s">
                                </div>
                                <!--end of col-->
                                <div class="col-auto">
            ...
            <header class="mb-5 mt-5">
                <h2 class="page-title text-center search-result-found--custom"> <?php echo $wp_query->found_posts; ?>
