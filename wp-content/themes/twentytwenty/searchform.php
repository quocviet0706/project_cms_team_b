		...
		<div class="col-md-10 col-lg-12">
			<form class="card card-sm" role="search" <?php echo $twentytwenty_aria_label; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- Escaped above. 
				...
				<div class="card-body row no-gutters align-items-center">
					...
					<!--end of col-->
					<div class="col">
						<input class="form-control form-control-lg form-control-borderless search-field" 
						type="search"
						id="<?php echo esc_attr($twentytwenty_unique_id); ?>" placeholder="<?php echo esc_attr_x('Search &hellip;', 'placeholder', 'twentytwenty'); ?>" value="<?php echo get_search_query(); ?>" name="s">
					</div>
					<!--end of col-->
					<div class="col-auto">
						<button class="btn btn-lg btn-success search-submit"
						type="submit" class="search-submit" value="<?php echo esc_attr_x('Search', 'submit button', 'twentytwenty'); ?>">
							Search
						</button>
					</div>
					<!--end of col-->
